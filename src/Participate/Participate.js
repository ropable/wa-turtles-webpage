...
import { Container, Jumbotron, Row, Card, CardBody } from "reactstrap";
    ...
    return (
      <Container>
        <Jumbotron>
          <h1>Get involved</h1>
          <p>
            If you would like to get involved in turtle conservation work, this
            is how to get hands-on and feet on the ground.
          </p>
        </Jumbotron>
          ...
          <Card>
            <CardBody>
              ...
              <p>
                ...
                islands off the coast of Onslow, WA. The island is accessed by a
                45-minute boat trip. Staff and volunteers will stay at fully
                self-contained cabins. Cabins have two to five bedrooms with two
                single beds in each bedroom, so staff and volunteers will be
                expected to share. When possible, gender specific rooms will be
                allocated.
              </p>
              <h4>Cost</h4>
              Covered:
              ...
              <ul>
                <li>
                  Food and accommodation in Perth/Onslow prior to and after the
                  trip to Thevenard Island.
                </li>
              ...
              <p>
                ...
                on the beach, so staff and volunteers will be expected to share.
                When possible, gender specific tents will be allocated.
              </p>
              <h4>Cost</h4>
              <p>Covered:</p>
              <ul>
              ...
              <ul>
                <li>walk the beach at night for five/six hours carrying 6kg</li>
                ...
                <li>
                  ...
                  in accordance with the Department of Parks and Wildlife’s Code
                  of Conduct. Senior First Aid qualification is desirable.
                </li>
              </ul>
            </CardBody>
          </Card>
