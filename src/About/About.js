    ...
    return (
      <Container>
        <Jumbotron>
          ...
          <p>
            This page gives a short overview of the North West Shelf Flatback
          ...
          <Card>
            <CardBody>
              ...
              <p>
                ...
                throughout their range. Research is still needed to define the
                abundance and distribution of the flatback population of the
                North West Shelf and work being done includes:
              </p>
              <ul>
              ...
              <p>
                ...
                the 2009 Variation Agreement to the Barrow Island Act 2003).
              </p>
              <h2>The need for a large-scale conservation program</h2>
              <p>
                Barrow Island has long been known for being a modern day ‘Noah’s
                Ark’ with species like the golden bandicoot and the burrowing
                bettong surviving here, despite extinctions on the mainland.
                Possibly less well-known is that Barrow Island is used by
                thousands of female flatback turtles each year, who migrate to
                the island to lay their eggs. Flatbacks only nest across
                Northern Australia, so this rookery is not just significant for
                flatbacks in WA, but potentially for global abundance. The
                island hosts the production facility for Australia’s largest
                onshore oil field and more recently a liquefied natural gas
                plant. With the approval of the Gorgon Gas Project came funding
                to conserve the flatback turtle and determine whether the Gorgon
                Gas Project is having a significant impact on the population of
                flatbacks nesting there.
              </p>
              ...
              <p>
                ...
                only recognised as a separate species from green turtles in the
                1970’s. Part of the reason for this is that they nest on remote
                beaches and forage in murky water, which is often shared with
                sharks and salt water crocodiles.
              </p>
              <p>
                Flatbacks nest on mainland and island beaches from Exmouth Gulf
                (WA) to Bundaberg (QLD). They migrate to offshore feeding
                ...
                Flatbacks feed on soft-bottomed sea beds at 10-100m depth. They
                have a unique skin-like carapace which makes them sensitive to
                touch, and not suited to reef environments.
              </p>
              <p>
              ...
              <ul>
                ...
                <li>How do hatchlings disperse, which habitats do they use?</li>
                <li>
                  Where do they mate, what do they do between laying clutches of
                  eggs?
                </li>
                <li>
              ...
              <p>
                ...
                detail about their abundance and distribution. This program and
                others around Australia are aiming to clarify this status. The
                North West Shelf Flatbacks face many threats and the management
                plan identifies and ranks their threats to prioritise
                conservation action.
              </p>
